    ...
    return (
        <div className="w-[500px] max-w-[800px]    mt-20 mx-auto p-5 bg-gray-400    rounded-lg flex flex-col mob:w-[375px] mob:h-screen tab:h-[60%] relative">
            ...
            <div className="flex justify-between mx-5 mt-10 mb-5">
                ...
                <button
                    className={`text-white ${image && fileName ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-400 cursor-not-allowed'} focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 transition duration-300`}
                    onClick={onNext}
